...
if __name__ == '__main__':
    input_dir = r'/opt/airflow/data/LTE-Nokia-MT_10.27.5.12/source'
    conf_file = r'/opt/airflow/data/LTE-Nokia-MT_10.27.5.12/nsnxml2csv2.conf'
    output1_dir = r'/opt/airflow/data/LTE-Nokia-MT_10.27.5.12/archive'
    output2_dir = r'/opt/airflow/data/LTE-Nokia-MT_10.27.5.12/output'
    temp_dir = r'/opt/airflow/data/LTE-Nokia-MT_10.27.5.12/staging'
    log_file = r'/opt/airflow/data/LTE-Nokia-MT_10.27.5.12/logs/extraction_log.xlsx'
