...
# Cấu hình thư mục
RAW_DATA_DIR = r'/opt/airflow/data/huawei-lte_U2020-TAISHAN/source'
OUTPUT1_DIR = r'/opt/airflow/data/huawei-lte_U2020-TAISHAN/archive'
OUTPUT2_DIR = r'/opt/airflow/data/huawei-lte_U2020-TAISHAN/output'
LOG_FILE = r'/opt/airflow/data/huawei-lte_U2020-TAISHAN/logs/extraction_log.xlsx'
CONF_FILE = r'/opt/airflow/data/huawei-lte_U2020-TAISHAN/huawei-lte_U2020-TAISHAN.conf'
