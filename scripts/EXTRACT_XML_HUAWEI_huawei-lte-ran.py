...
# Cấu hình thư mục
RAW_DATA_DIR = r'/opt/airflow/data/huawei-lte-ran/source'
OUTPUT1_DIR = r'/opt/airflow/data/huawei-lte-ran/archive'
OUTPUT2_DIR = r'/opt/airflow/data/huawei-lte-ran/output'
LOG_FILE = r'/opt/airflow/data/huawei-lte-ran/logs/extraction_log.xlsx'
CONF_FILE = r'/opt/airflow/data/huawei-lte-ran/huawei-lte-ran.conf'
