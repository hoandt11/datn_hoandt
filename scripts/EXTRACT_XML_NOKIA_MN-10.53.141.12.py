...
if __name__ == '__main__':
    input_dir = r'/opt/airflow/data/LTE-Nokia-MN-10.53.141.12/source'
    conf_file = r'/opt/airflow/data/LTE-Nokia-MN-10.53.141.12/nsnxml2csv2.conf'
    output1_dir = r'/opt/airflow/data/LTE-Nokia-MN-10.53.141.12/archive'
    output2_dir = r'/opt/airflow/data/LTE-Nokia-MN-10.53.141.12/output'
    temp_dir = r'/opt/airflow/data/LTE-Nokia-MN-10.53.141.12/staging'
    log_file = r'/opt/airflow/data/LTE-Nokia-MN-10.53.141.12/logs/extraction_log.xlsx'
